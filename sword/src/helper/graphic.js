...
const LETTER_8 = `...`; // Define the letter '8' as needed
const LETTER_K = `...`; // Define the letter 'K' as needed
const LETTER_M = `...`; // Define the letter 'M' as needed
const LETTER_U = `...`; // Define the letter 'U' as needed
const LETTER_S = `...`; // Define the letter 'S' as needed;

const scale = 0.6;

const letters = [
  decompressPath(LETTER_8, -10, 0, scale),
  decompressPath(`...`, -70, 85, scale), // Define the letter 'K' here
  decompressPath(LETTER_M, -150, 88, scale),
  decompressPath(`...`, -230, 97, scale), // Define the letter 'U' here
  decompressPath(`...`, -275, 90, scale), // Define the letter 'S' here
  decompressPath(`...`, -290, 90, scale), // Define the letter 'S' here
  decompressPath(LETTER_S, -340, 0, scale),
  decompressPath(`...`, -380, 5, scale), // Define the letter 'O' here
  decompressPath(LETTER_M, -500, 88, scale),
  decompressPath(`...`, -545, 95, scale), // Define the letter 'U' here
  decompressPath(`...`, -580, 90, scale), // Define the letter 'S' here
];
